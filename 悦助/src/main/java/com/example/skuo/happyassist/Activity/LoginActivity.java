...
import com.example.skuo.happyassist.AppUpdate.UpdateManager;
import com.example.skuo.happyassist.Javis.Data.USERINFO;
import com.example.skuo.happyassist.Javis.Tools.PermissionsUtil;
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                return USERINFO.AuthLogin(mEmail, mPassword);
            } catch (Exception e) {
                return false;
            }
        }
