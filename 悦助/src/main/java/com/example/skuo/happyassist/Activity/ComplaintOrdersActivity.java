...
import com.example.skuo.happyassist.Class.Result.Complaint;
import com.example.skuo.happyassist.Class.Result.ComplaintInfo;
import com.example.skuo.happyassist.Javis.Adapter.Adapter_complaint_order;
...
public class ComplaintOrdersActivity extends Activity {
    ...
    private static final String TAG = "ComplaintOrderActivity";

    private Adapter_complaint_order rep_Adapter;
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.iv_refresh:
                    Intent intent = new Intent(ComplaintOrdersActivity.this, ComplaintFilterActivity.class);
    ...
    private void initView() {
        ((TextView) findViewById(R.id.tv_top_title)).setText("建议工单");
        ...
        rep_Adapter = new Adapter_complaint_order(mContext, arrayList);
            ...
            switch (msg.what) {
                ...
                case JUMP_TO_DETAIL:
                    try {
                        ...
                        ComplaintInfo complaintInfo = (ComplaintInfo) msg.obj;
    ...
    private class WareTask extends AsyncTask<Void, Void, HashMap<String, Object>> {
        ...
        protected HashMap<String, Object> doInBackground(Void... arg0) {
            try {
                ...
                //请求数据，返回json
                String jsonStr = GetHttp.RequstGetHttp(Interface.GetComplaintList, param);
                Complaint complaint = JSON.parseObject(jsonStr, Complaint.class);

                TotalCount = complaint.Data.TotalCount;
                hashMap = new HashMap<>();
                hashMap.put("data", complaint.Data.Complaints);
            } catch (Exception e) {
                e.printStackTrace();
            }
