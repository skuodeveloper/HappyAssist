package com.example.skuo.happyassist.AppUpdate;
...
public class UpdateManager {
    ...
    private static final String APK_NAKE = "YUEZHU.apk";
...
//    }
    ...
    private int getVersionCode(Context context) {
        ...
        try {
            ...
            versionCode = context.getPackageManager().getPackageInfo("com.example.skuo.happyassist", 0).versionCode;
    ...
    private String getVersionName(Context context) {
        ...
        try {
            // 获取软件版本号，对应AndroidManifest.xml下android:versionCode
            versionName = context.getPackageManager().getPackageInfo("com.example.skuo.happyassist", 0).versionName;
        } catch (NameNotFoundException e) {
            e.printStackTrace();
        }
        return versionName;
        ...
        public void run() {
            ...
            try {
                ...
                if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                    ...
                    //URL url = new URL(appVersion.Data.DownloadUrl);
                    URL url = new URL("http://121.40.75.37:808/YueZhuApp/YUEZHU_1.0.1.apk");
//                    String urls = "http://121.40.75.37:808/YueZhuApp/" + URLEncoder.encode("悦助1.0.1.apk", "GB2312");
