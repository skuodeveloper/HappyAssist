...
import com.example.skuo.happyassist.Activity.AlbumActivity;
import com.example.skuo.happyassist.Activity.ShowAllPhotoActivity;
...
public class Adapter_Folder extends BaseAdapter {
    ...
    public Adapter_Folder(Context c) {
