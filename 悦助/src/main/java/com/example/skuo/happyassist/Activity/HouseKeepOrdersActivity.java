...
import com.example.skuo.happyassist.Class.Result.HouseKeep;
import com.example.skuo.happyassist.Class.Result.HouseKeepInfo;
import com.example.skuo.happyassist.Javis.Adapter.Adapter_housekeep_order;
...
public class HouseKeepOrdersActivity extends Activity {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.iv_refresh:
                    Intent intent = new Intent(HouseKeepOrdersActivity.this, HouseKeepFilterActivity.class);
    ...
    */
    ...
    private void initView() {
        ((TextView) findViewById(R.id.tv_top_title)).setText("家政订单");
        ...
        rep_Adapter = new Adapter_housekeep_order(mContext, arrayList);
    ...
    private class WareTask extends AsyncTask<Void, Void, HashMap<String, Object>> {
        ...
        protected HashMap<String, Object> doInBackground(Void... arg0) {
            try {
                ...
                //请求数据，返回json
                String jsonStr = GetHttp.RequstGetHttp(Interface.GetAppointmentList, param);
                HouseKeep houseKeep = JSON.parseObject(jsonStr, HouseKeep.class);

                TotalCount = houseKeep.Data.TotalCount;
                hashMap = new HashMap<>();
                hashMap.put("data", houseKeep.Data.NeighborhoodServiceOrderItems);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return hashMap;
