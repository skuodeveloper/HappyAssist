 ...
 */
public class MyCustomListView extends ListView implements OnScrollListener {
    ...
    public MyCustomListView(Context pContext, AttributeSet pAttrs) {
        super(pContext, pAttrs);
        init(pContext);
    }

    public MyCustomListView(Context pContext) {
        super(pContext);
        init(pContext);
    }

    public MyCustomListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
