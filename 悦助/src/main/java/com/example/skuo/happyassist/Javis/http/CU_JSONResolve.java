...
public class CU_JSONResolve {
     ...
     * 解析完整的1层JSON对象
     *
     * @param jsonStr    未解析的JSON字符串
     * @param STR1_field 第一层String类型的key数组
     * @param 以下是传参示例    ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
     ...
     * @param jsonStr                                             未解析的JSON字符串
     * @param STR1_field                                          第一层String类型的key数组
     * @param LIST1_field                                         第一层List类型的key数组
     * @param aL_STR2_field                                       第二层String类型的key列表(列表项为String[]:一层LIST1_field对应的String类型的key数组)
     * @param 以下是传参示例                                             ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
...
//					return hashMap;
     ...
     * @param LIST1_field                                                         第一层List类型的key数组
     * @param aL_STR2_field                                                       第二层String类型的key列表(列表项为String[]:一层LIST1_field对应的String类型的key数组)
     * @param aL_LIST2_field                                                      第二层List类型key列表,同aL_STR2_field
     * @param aL_STR3_field                                                       第三层String类型的key列表套列表(ArrayList$ArrayList$String[]%%)//$和%换尖扩号
     * @param 以下是传参示例                                                             ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
     * @param //一层2个String1个list,2层分别为4个String和2个List,3层分别为(分别为6个String和5个String) 和()和()...
